  ...
  const DragDropTouch = (function () {
    ...
    function DragDropTouch () {
      ...
      if ('ontouchstart' in document) {
        const d = document; const ts = this._touchstart.bind(this); const tm = this._touchmove.bind(this); const te = this._touchend.bind(this); const opt = supportsPassive ? { passive: false, capture: false } : false
